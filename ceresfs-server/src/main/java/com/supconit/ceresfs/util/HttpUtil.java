...
public class HttpUtil {
    ...
    public static FullHttpResponse newResponse(HttpResponseStatus status, String mimeType, String message) {
    ...
    public static FullHttpResponse newResponse(HttpResponseStatus status, String mimeType, byte[] data) {
